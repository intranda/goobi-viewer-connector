 ...
 */
package de.intranda.digiverso.m2m.oai.model.language;
...
public class LocaleComparator implements Comparator<Locale> {
    ...
    public int compare(Locale l1, Locale l2) {
        ...
        int i1 = l1.getLanguage()
                .equals(primaryLocale.getLanguage()) ? 1
                        : (l1.getLanguage()
                                .equals(secondaryLocale.getLanguage()) ? 2 : 3);
        int i2 = l2.getLanguage()
                .equals(primaryLocale.getLanguage()) ? 1
                        : (l2.getLanguage()
                                .equals(secondaryLocale.getLanguage()) ? 2 : 3);
